...
build_macosx64 {
    QMAKE_TARGET_BUNDLE_PREFIX = co.CattleCurrency
    BOOST_LIB_SUFFIX=-mt
...
# also add new translations to CattleCurrency.qrc under translations/
...
macx:ICON = src/qt/res/icons/CattleCurrency.icns
macx:TARGET = "CattleCurrency"
